...
class main_controller extends CI_Controller
{
    ...
    {
        $this->load->view('../views/questions/multiplechoice');
    }
    public function multiplechoicetest()
    {
        $this->load->view('../views/questions/multiplechoice_copy');
    }
    public function fill_in_the_blank()
    {
        $this->load->view('../views/questions/fill_in_the_blank');
    }
    public function fill_in_the_blank_test()
    {
        $this->load->view('../views/questions/fill_in_the_blank_copy');
    }
    public function studentEnterCode()
    {
        $this->load->view('../views/player/entercode');
    }
    public function animatepage() {
        $this->load->view('../views/questions/animate_page1');
    }
    public function animatepage2() {
        $this->load->view('../views/questions/animate_page2');
    }
    public function rankperpage() {
        $this->load->view('../views/questions/rankingperquestion');
    }
    public function countdownblue() {
        $this->load->view('../views/questions/countdownblue');
    }
    public function countdownred() {
        $this->load->view('../views/questions/countdownred');
    }
    public function waitingplayer() {
        $this->load->view('../views/questions/waitingplayer');
    }
